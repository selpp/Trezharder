# Map Manager
import pygame
import games.pacman.resources_config as res

from engine.core.data_manager import TileInfos
...
class MapManager(MonoBehaviour):
	def __init__(self):
		...
		self.data_manager.load_tile('CLAY', res.GRAPHICS + 'CLAY.jpg', self.infos)
		self.data_manager.load_tile('STONE', res.GRAPHICS + 'STONE.jpg', self.infos)
		self.data_manager.load_tile('WOOD', res.GRAPHICS + 'WOOD.jpg', self.infos)
