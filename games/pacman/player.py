...
from engine.core.fsm import State, FSM
...
class Player(MonoBehaviour):
	...
	def start(self):
		...
		data_manager = DataManager.get_instance()
		if self.color == 0:
			data_manager.load_sprite_sheet('TRUMP1', res.GRAPHICS + 'TEST1.png', infos)
			spriteSheet = data_manager.get_sprite_sheet('TRUMP1')
		else:
			data_manager.load_sprite_sheet('TRUMP2', res.GRAPHICS + 'TEST2.png', infos)
		...
		data_manager = DataManager.get_instance()
		data_manager.load_sprite_sheet('EXPLOSION', res.GRAPHICS + 'EXPLOSION.png', infos)
